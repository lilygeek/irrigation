...
envs = envs.to_numpy()
print(envs)
irrigation =np.absolute(irrigation.to_numpy().reshape(-1,1))
...
model = d3rlpy.algos.BCQ(use_gpu=True)

model.fit(train_episodes,eval_episodes=test_episodes,n_epochs=1000,
        scorers={
